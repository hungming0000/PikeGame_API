...
namespace WebBO.Models
{
    ...
    //    /// <param name="DT"></param>
    //    /// <returns></returns>
    //    public static DTParameters ParseDTParameters(string DT)
    //    {
    //        DTParameters P = new DTParameters();
    ...
    //    /// <param name="DT"></param>
    //    /// <returns></returns>
    //    public static DTSearch ParseDTSearch(string DT)
    //    {
    //        return null;
    //    }
    //}
    ...
    public class DTParameters
    {
        ...
        /// <summary>
        /// 新版契約清單介面所需排序參數(20200918)
        /// OrderCol,OrderRul
        /// </summary>
        public string OrderCol { get; set; }
        public string OrderRul { get; set; }
